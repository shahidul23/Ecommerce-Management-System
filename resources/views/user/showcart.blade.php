    	...
    	<form action="{{url('order')}}" method="POST">
    		...
    		<tr align="center" style="background-color: #E5E4E2">
    			<td style="padding: 10px; color: black">
    				<input type="text" name="productname[]" hidden="" value="{{$carts->product_title}}"
    				 >
    				{{$carts->product_title}}
    			</td>
    			<td style="padding: 10px; color: black">
                    <input type="text" name="quantity[]" hidden="" value="{{$carts->quantity}}">
    				{{$carts->quantity}}</td>
    			<td style="padding: 10px; color: black">
                    <input type="text" name="price[]" hidden="" value="{{$carts->product_price}}">
    				{{$carts->product_price}}</td>
    			<td style="padding: 10px; color: black"><a onclick="return confirm('Are you sure Remove this Product')" class="btn btn-danger" href="{{url('delete',$carts->id)}}">Remove</a></td>
    		</tr>
    		@endforeach
    	</table>
    	<br>
